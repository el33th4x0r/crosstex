...
Conditional fields defined in the \textt{nsdi} object will define the
...
Such modules can be includes with the \textt{@include} primitive.
...
will cause \XTeX{} to issue a warning. Passing \XTeX{} the \textt{--strict} flag will force it to issue such warnings even when the objects are identical,
